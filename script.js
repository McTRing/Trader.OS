...
<aside class="sidebar">
  ...
  <nav class="nav">
    ...
    <div class="ni" onclick="go(this,'leaderboard')"><span class="ni-ic">🏆</span>Leaderboard<span class="nbadge" id="nb-lb">0</span></div>
    <div class="ni" onclick="go(this,'feed')"><span class="ni-ic">💬</span>Feed del Grupo<span class="nbadge" id="nb-feed">0</span></div>
    <div class="nsec">Mi Trading</div>
    <div class="ni" onclick="go(this,'checklist')"><span class="ni-ic">✅</span>Checklist Pre-Trade<span class="nbadge warn" id="nb-chk">!</span></div>
    <div class="ni" onclick="go(this,'diario')"><span class="ni-ic">📋</span>Diario Inteligente<span class="nbadge" id="nb-trades">0</span></div>
    <div class="ni" onclick="go(this,'patrones')"><span class="ni-ic">🧬</span>Análisis de Patrones</div>
    <div class="ni" onclick="go(this,'riesgo')"><span class="ni-ic">🛡️</span>Calculadora Riesgo</div>
    <div class="ni" onclick="go(this,'conversor')"><span class="ni-ic">💱</span>Conversor de Monedas<span class="nbadge" id="nb-fx">LIVE</span></div>
    <div class="nsec">Educación</div>
    <div class="ni" onclick="go(this,'radar')"><span class="ni-ic">🌍</span>Radar de Noticias<span class="nbadge warn" id="nb-radar">NEW</span></div>
    <div class="ni" onclick="go(this,'ai')"><span class="ni-ic">🤖</span>Análisis IA</div>
    <div class="ni" onclick="go(this,'aprendizaje')"><span class="ni-ic">🎓</span>Ruta de Aprendizaje</div>
    <div class="ni" onclick="go(this,'calendario')"><span class="ni-ic">🗓️</span>Calendario</div>
  </nav>
  <div class="sb-bot">
    <div style="display:flex;align-items:center;gap:8px">
      ...
      <div style="flex:1;min-width:0">
        ...
        <div style="font-size:9px;color:var(--text3)">Swing · Acciones + Cripto</div>
      </div>
      <button class="btn bg2b" style="font-size:9px;padding:2px 7px" onclick="changeUser()">✏️</button>
    </div>
  </div>
</aside>
...
<div class="main">
  <div class="topbar">
    ...
    <div style="display:flex;align-items:center;gap:8px">
      <span class="chip" id="streak-chip">🔥 0 días</span>
  ...
  <div class="page on" id="p-dashboard">
    <div class="kpi-row k4">
      ...
      <div class="kpi y"><div class="kl">Profit Factor</div><div class="kv y" id="k-pf">—</div><div class="ks">G ÷ P</div></div>
      <div class="kpi r"><div class="kl">Max Drawdown</div><div class="kv r" id="k-dd">0%</div><div class="ks">Caída máx.</div></div>
    </div>
    <div class="card" style="margin-bottom:12px">
      <div class="ch"><span class="ct">Ticker Live — TradingView</span><span class="ctag bl">Datos reales</span></div>
      <div class="cb p0">
        <div class="tradingview-widget-container">
          <div class="tradingview-widget-container__widget"></div>
          <script type="text/javascript" src="https://s3.tradingview.com/external-embedding/embed-widget-ticker-tape.js" async>
          {"symbols":[{"proName":"NASDAQ:NVDA","title":"NVIDIA"},{"proName":"NASDAQ:AAPL","title":"Apple"},{"proName":"NASDAQ:TSLA","title":"Tesla"},{"proName":"NASDAQ:MSFT","title":"MSFT"},{"proName":"NASDAQ:META","title":"Meta"},{"proName":"NASDAQ:GOOGL","title":"Google"},{"proName":"NASDAQ:AMZN","title":"Amazon"},{"proName":"NYSE:AMD","title":"AMD"},{"proName":"NYSE:COIN","title":"Coinbase"},{"proName":"NASDAQ:MSTR","title":"MicroStrategy"},{"proName":"AMEX:SPY","title":"S&P500"},{"proName":"NASDAQ:QQQ","title":"QQQ"},{"proName":"BINANCE:BTCUSDT","title":"Bitcoin"},{"proName":"BINANCE:ETHUSDT","title":"Ethereum"},{"proName":"BINANCE:SOLUSDT","title":"Solana"},{"proName":"BINANCE:BNBUSDT","title":"BNB"},{"proName":"BINANCE:XRPUSDT","title":"XRP"},{"proName":"BINANCE:DOGEUSDT","title":"DOGE"},{"proName":"FX:EURUSD","title":"EUR/USD"},{"proName":"FX:USDMXN","title":"USD/MXN"},{"proName":"TVC:GOLD","title":"Oro"},{"proName":"NYMEX:CL1!","title":"Petróleo"}],"showSymbolLogo":true,"isTransparent":true,"displayMode":"adaptive","colorTheme":"dark","locale":"es"}
          </script>
        </div>
      </div>
    </div>
    <div class="row">
      ...
      <div class="card col">
        ...
        <div class="cb p0" id="qstats"><div style="padding:28px;text-align:center;color:var(--text3);font-size:11px">Registrá operaciones<br>en el Diario.</div></div>
      </div>
    </div>
    <div class="row">
      <div class="card col">
      ...
      <div class="card col">
        <div class="ch"><span class="ct">Último del Feed</span><span class="ctag bl">Grupo</span></div>
        <div class="cb p0" id="dash-feed" style="max-height:160px;overflow-y:auto"></div>
      </div>
      <div class="card col">
        <div class="ch"><span class="ct">Eventos Clave</span><span class="ctag rd">🔴 Hoy</span></div>
    ...
    <div class="card" style="height:calc(100vh - 96px)">
      <div class="ch" style="flex-direction:column;align-items:flex-start;gap:7px">
        <div style="display:flex;align-items:center;justify-content:space-between;width:100%">
          <span class="ct">Gráfico Interactivo — TradingView</span>
          <span class="ctag" id="sym-cur">NVDA</span>
        </div>
        <div style="display:flex;align-items:center;gap:5px;flex-wrap:wrap">
          <input id="sym-search" class="fi" style="max-width:160px;padding:4px 8px;font-size:10px" placeholder="Buscar símbolo…" onkeydown="if(event.key==='Enter')searchSym()">
          <button class="btn bp" style="padding:4px 9px;font-size:10px" onclick="searchSym()">Ir →</button>
          <button class="btn bg2b cat-btn on" style="font-size:9px;padding:3px 7px" onclick="setCat(this,'tech')">🖥 Tech</button>
          <button class="btn bg2b cat-btn" style="font-size:9px;padding:3px 7px" onclick="setCat(this,'cripto')">₿ Cripto</button>
          <button class="btn bg2b cat-btn" style="font-size:9px;padding:3px 7px" onclick="setCat(this,'forex')">💱 Forex</button>
          <button class="btn bg2b cat-btn" style="font-size:9px;padding:3px 7px" onclick="setCat(this,'etf')">📦 ETFs</button>
          <button class="btn bg2b cat-btn" style="font-size:9px;padding:3px 7px" onclick="setCat(this,'materias')">🛢 Materias</button>
          <button class="btn bg2b cat-btn" style="font-size:9px;padding:3px 7px" onclick="setCat(this,'latam')">🌎 LatAm</button>
        </div>
  ...
  <div class="page" id="p-screener">
    <div class="row" style="height:calc(50vh - 60px)">
      <div class="card col" style="height:100%">
        <div class="ch"><span class="ct">Screener — Acciones USA</span><span class="ctag bl">Live</span></div>
        <div class="cb p0" style="flex:1;min-height:0">
          <div class="tradingview-widget-container" style="height:100%;width:100%">
      ...
      <div class="card col" style="height:100%">
        <div class="ch"><span class="ct">Screener — Cripto</span><span class="ctag bl">Live</span></div>
        <div class="cb p0" style="flex:1;min-height:0">
          <div class="tradingview-widget-container" style="height:100%;width:100%">
            <div class="tradingview-widget-container__widget" style="height:100%;width:100%"></div>
            <script type="text/javascript" src="https://s3.tradingview.com/external-embedding/embed-widget-screener.js" async>
    ...
    <div class="card" style="margin-top:12px">
      <div class="ch"><span class="ct">Market Overview — Índices · Cripto · Tech</span></div>
      <div class="cb p0">
        <div class="tradingview-widget-container">
          <div class="tradingview-widget-container__widget"></div>
          <script type="text/javascript" src="https://s3.tradingview.com/external-embedding/embed-widget-market-overview.js" async>
          {"colorTheme":"dark","dateRange":"1D","showChart":true,"locale":"es","isTransparent":true,"showSymbolLogo":true,"width":"100%","height":"360","tabs":[{"title":"Índices","symbols":[{"s":"FOREXCOM:SPXUSD","d":"S&P 500"},{"s":"FOREXCOM:NSXUSD","d":"NASDAQ 100"},{"s":"FOREXCOM:DJI","d":"Dow Jones"},{"s":"INDEX:NKY","d":"Nikkei"},{"s":"INDEX:DEU40","d":"DAX"}]},{"title":"Cripto","symbols":[{"s":"BINANCE:BTCUSDT","d":"BTC"},{"s":"BINANCE:ETHUSDT","d":"ETH"},{"s":"BINANCE:SOLUSDT","d":"SOL"},{"s":"BINANCE:BNBUSDT","d":"BNB"},{"s":"BINANCE:XRPUSDT","d":"XRP"}]},{"title":"Tech USA","symbols":[{"s":"NASDAQ:NVDA"},{"s":"NASDAQ:AAPL"},{"s":"NASDAQ:TSLA"},{"s":"NASDAQ:MSFT"},{"s":"NASDAQ:META"}]}]}
          </script>
        </div>
      </div>
    </div>
  ...
  <div class="page" id="p-leaderboard">
    <div class="kpi-row k3">
      ...
      <div class="kpi y"><div class="kl">Tu Posición</div><div class="kv y" id="lb-rank">#—</div><div class="ks">En el grupo</div></div>
    </div>
    <div class="row">
      <div class="card col2">
        <div class="ch">
          <span class="ct">🏆 Leaderboard del Grupo</span>
          <div style="display:flex;gap:6px">
            <span class="ctag bl" id="lb-count-tag">0 traders</span>
            <button class="btn bwa" style="font-size:10px;padding:3px 10px" onclick="shareToWhatsApp('leaderboard')">📱 WhatsApp</button>
          </div>
        </div>
        ...
        <div style="padding:10px 14px;border-top:1px solid var(--border);display:flex;align-items:center;gap:8px">
          <span style="font-size:10px;color:var(--text3);flex:1">📲 Mandá este link por WhatsApp para que el grupo se una</span>
          <button class="btn bg2b" style="font-size:9px;padding:3px 8px" onclick="copyLink()">📋 Copiar link</button>
          <button class="btn bwa" style="font-size:9px;padding:3px 8px" onclick="inviteWhatsApp()">Invitar 📱</button>
        </div>
      </div>
      <div class="card col">
        <div class="ch"><span class="ct">Mis Stats para el Grupo</span></div>
        <div class="cb">
          <div style="font-size:11px;color:var(--text2);margin-bottom:12px;line-height:1.6">Tus estadísticas se sincronizan automáticamente con el leaderboard cada vez que registrás un trade.</div>
          <div id="my-stats-box"></div>
          <div style="margin-top:12px;padding-top:12px;border-top:1px solid var(--border)">
            <button class="btn bp" style="width:100%;margin-bottom:6px" onclick="publishMyStats()">🔄 Sincronizar mis stats</button>
            <button class="btn bwa" style="width:100%" onclick="shareToWhatsApp('mystats')">📱 Compartir mis stats por WhatsApp</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="page" id="p-feed">
    <div class="row">
      <div class="card col">
        <div class="ch">
          <span class="ct">💬 Compartir Trade con el Grupo</span>
          <button class="btn bwa" style="font-size:10px;padding:3px 10px" onclick="shareToWhatsApp('feed')">📱 WhatsApp</button>
        </div>
        <div class="cb">
          <div class="fgrid g3" style="margin-bottom:8px">
            <div class="fg"><label class="fl">Activo</label><input class="fi" id="share-asset" placeholder="NVDA, BTC…"></div>
            <div class="fg">
            ...
            <div class="fg">
              ...
              <input class="fi" id="share-pnl" type="number" placeholder="±0.00">
            </div>
          </div>
          <div class="fg" style="margin-bottom:10px">
            <label class="fl">Setup visto + Aprendizaje (¿qué harías diferente?)</label>
            <textarea class="fi" id="share-note" rows="3" placeholder="Ej: Ruptura de resistencia en NVDA con volumen 3x. Entré demasiado tarde, próxima vez entro en el retroceso a la zona rota…" style="resize:vertical;line-height:1.5"></textarea>
          </div>
          <div style="display:flex;gap:8px">
            <button class="btn bp" onclick="postFeed()">📤 Publicar en el feed</button>
            <button class="btn bwa" onclick="postAndWhatsApp()">📱 Publicar + enviar por WhatsApp</button>
          </div>
        </div>
      </div>
      <div class="card col">
  ...
  <div class="page" id="p-checklist">
    <div class="row">
      <div class="card col2">
        <div class="ch"><span class="ct">Checklist Pre-Trade — Anti Emocional</span><span class="ctag" id="chk-tag">0 / 8</span></div>
        <div class="cb">
          <p style="font-size:11px;color:var(--text2);margin-bottom:10px">Completá el <strong>100%</strong> antes de registrar cualquier operación. Si no podés marcar algún ítem, <strong style="color:var(--red)">no operes</strong>.</p>
          ...
          <div style="display:flex;gap:8px;margin-top:12px">
            <button class="btn bp" id="btn-open-diario" onclick="go(document.querySelector('.ni[onclick*=diario]'),'diario')" disabled style="opacity:.4">✅ Lista completa — Ir al diario</button>
            <button class="btn bg2b" onclick="resetChk()">Resetear</button>
          </div>
        </div>
      </div>
      <div class="card col">
        <div class="ch"><span class="ct">Estado Emocional del Día</span></div>
        <div class="cb">
          <p style="font-size:11px;color:var(--text2);margin-bottom:10px">¿Cómo te sentís para operar hoy?</p>
          <div class="emo-row" id="emo-btns"></div>
          <div style="font-size:11px;margin-top:10px;padding:10px;border-radius:5px;border:1px solid var(--border);background:var(--bg3)" id="emo-feedback">Seleccioná tu estado.</div>
          <div style="margin-top:14px;padding-top:14px;border-top:1px solid var(--border)">
            ...
            <div style="font-size:11px;color:var(--text2);line-height:2">
              📌 Máx. 3 operaciones por día<br>
              📌 No muevas el stop-loss<br>
              📌 3% de pérdida → cerrás la plataforma<br>
              📌 Registrá cada trade antes del siguiente
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="page" id="p-diario">
    <div class="card" style="margin-bottom:12px">
      <div class="ch"><span class="ct">Registrar Operación</span><span class="ctag bl">Diario Inteligente</span></div>
      <div class="cb">
        <div class="fgrid g3">
          <div class="fg"><label class="fl">Activo</label><input class="fi" id="ta" placeholder="NVDA, BTC…"></div>
          <div class="fg"><label class="fl">Dirección</label><select class="fi" id="td"><option>LONG</option><option>SHORT</option></select></div>
          ...
          <div class="fg"><label class="fl">P&L ($)</label><input class="fi" id="tpnl" type="number" placeholder="±0.00"></div>
        </div>
        <div class="fgrid g3">
          <div class="fg">
            <label class="fl">Setup / Patrón</label>
            <select class="fi" id="tsetup">
              ...
              <option>Reversión en extremo</option><option>Seguimiento de tendencia</option>
              <option>Patrón de velas</option><option>Otro</option>
            </select>
          </div>
          <div class="fg">
            <label class="fl">Horario</label>
            <select class="fi" id="ttime">
              <option>Apertura (9:30-10:30)</option><option>Mañana (10:30-12:00)</option>
              <option>Mediodía (12:00-14:00)</option><option>Tarde (14:00-16:00)</option>
          ...
          <div class="fg">
            ...
            <select class="fi" id="temo">
              <option value="5">😎 5 — En zona</option>
              <option value="4">🙂 4 — Calmado</option>
              <option value="3">😐 3 — Neutro</option>
              <option value="2">😟 2 — Ansioso</option>
              <option value="1">😤 1 — Estrés/FOMO</option>
            </select>
          </div>
        </div>
        <div class="fg" style="margin-bottom:8px">
          <label class="fl">Notas — Setup visto, por qué entraste, ¿seguiste el plan?</label>
          <input class="fi" id="tn" placeholder="Ej: Ruptura de $190 con volumen 3x, RSI en 62, EMA20 como soporte. Salí en $197 como planeé.">
        </div>
        <div style="display:flex;gap:8px">
          <button class="btn bp" onclick="addTrade()">＋ Registrar</button>
  ...
  <div class="page" id="p-patrones">
    <div class="kpi-row k5">
      <div class="kpi g"><div class="kl">Mejor Día</div><div class="kv g" style="font-size:16px" id="pat-bd">—</div><div class="ks">Mayor P&L</div></div>
      <div class="kpi r"><div class="kl">Peor Día</div><div class="kv r" style="font-size:16px" id="pat-wd">—</div><div class="ks">Menor P&L</div></div>
      <div class="kpi b"><div class="kl">Mejor Setup</div><div class="kv b" style="font-size:11px" id="pat-bs">—</div><div class="ks">Más rentable</div></div>
      <div class="kpi p"><div class="kl">Mejor Estado</div><div class="kv p" id="pat-be">—</div><div class="ks">Mayor WR</div></div>
      <div class="kpi y"><div class="kl">Mejor Horario</div><div class="kv y" style="font-size:11px" id="pat-bt">—</div><div class="ks">Más rentable</div></div>
    </div>
    <div class="row">
      <div class="card col"><div class="ch"><span class="ct">P&L por Día de la Semana</span></div><div class="cb" id="pat-days"></div></div>
    ...
    <div class="card">
      <div class="ch"><span class="ct">🧬 Insights — Lo que tus datos te dicen</span><span class="ctag pu">Auto-generados</span></div>
      ...
      <div class="card col">
        ...
        <div class="cb">
          <div class="cgrid">
            ...
            <div class="fg"><label class="fl">R:R Mínimo</label><input class="fi" id="cm" type="number" value="2" step="0.1" oninput="calcR()"></div>
          </div>
          <div class="rbox">
            <div class="rr"><span class="rl">💰 Monto a Arriesgar</span><span class="rv" id="r-amt">$100.00</span></div>
            <div class="rr"><span class="rl">📦 Position Size</span><span class="rv big" id="r-sz">20 uds.</span></div>
            <div class="rr"><span class="rl">📉 Stop Distance</span><span class="rv" id="r-sl">$5.00</span></div>
            <div class="rr"><span class="rl">📈 TP Distance</span><span class="rv" id="r-tp">$10.00</span></div>
            <div class="rr"><span class="rl">⚖️ Ratio R:R</span><span class="rv" id="r-rr">1:2.00</span></div>
            <div class="rr"><span class="rl">✅ ¿Operar?</span><span class="rv ok" id="r-ok">SÍ — Válida</span></div>
          </div>
        </div>
      </div>
      <div class="card col">
  ...
  <div class="page" id="p-ai">
    <div class="row">
      <div class="card col2">
        <div class="ch">
          <span class="ct">🤖 Análisis de Mercado con IA</span>
          <div style="display:flex;gap:6px">
            <select class="fi" id="ai-sym" style="padding:3px 8px;font-size:10px;width:140px">
              <optgroup label="— Cripto —">
                <option>BTC</option><option>ETH</option><option>SOL</option><option>DOGE</option><option>GORK</option>
              </optgroup>
              <optgroup label="— Acciones USA —">
                <option>NVDA</option><option>TSLA</option><option>AAPL</option><option>META</option>
                <option>AMZN</option><option>FCX</option>
              </optgroup>
              <optgroup label="— ETFs —">
                <option>SPY</option><option>QQQ</option><option>GLD</option>
              </optgroup>
              <optgroup label="— Argentina —">
                <option>YPFD</option><option>PAMP</option><option>GGAL</option><option>AL30</option>
              </optgroup>
              <optgroup label="— Commodities —">
                <option>XAUUSD</option><option>XBRUSD</option>
              </optgroup>
            </select>
            <button class="btn bpu" onclick="runAI()" id="ai-btn">🤖 Analizar</button>
            <button class="btn bwa" onclick="shareAItoWhatsApp()" id="ai-wa-btn" style="display:none">📱 WA</button>
          </div>
        </div>
        <div class="cb" style="overflow-y:auto;max-height:500px" id="ai-out">
          <div class="ai-bubble">
            ...
            <div class="ai-body">Seleccioná un activo y presioná <strong>Analizar</strong>. Vas a recibir: sesgo direccional, niveles técnicos clave, contexto fundamental, y la sección de <strong>Aprendizaje</strong> explicando el razonamiento para que puedas replicarlo.</div>
          </div>
        </div>
      </div>
      <div class="card col">
        <div class="ch"><span class="ct">Configuración IA</span></div>
        <div class="cb">
          <div class="ins info"><span class="ins-ico">🤖</span><div class="ins-txt">Sin API key, los análisis son <strong>demos educativos</strong> pre-escritos. Con tu Anthropic API key, son <strong>análisis en tiempo real</strong> con contexto actual del mercado.</div></div>
          <div class="fg" style="margin-bottom:8px">
            <label class="fl">Anthropic API Key (opcional)</label>
            <input class="fi" id="api-key" type="password" placeholder="sk-ant-…">
          </div>
          <button class="btn bp" onclick="saveKey()" style="margin-bottom:14px">Guardar key</button>
          <div style="padding-top:12px;border-top:1px solid var(--border)">
            <div style="font-size:9px;text-transform:uppercase;letter-spacing:1px;color:var(--text3);margin-bottom:8px">Roadmap IA → N8N</div>
            <div style="font-size:11px;color:var(--text2);line-height:2">
              ✅ Análisis educativo (esta versión)<br>
              🔜 Análisis automático cada hora (N8N)<br>
              🔜 Paper trading con explicaciones<br>
              🔜 Alertas por WhatsApp automáticas<br>
              🔜 Conexión Binance API (lectura)<br>
              🔜 Cocos Capital API (portfolio)
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="page" id="p-aprendizaje">
    <div class="kpi-row k4" style="margin-bottom:12px">
      <div class="kpi b"><div class="kl">Progreso</div><div class="kv b" id="lp">0%</div><div class="ks" id="lps">0/9</div></div>
      <div class="kpi g"><div class="kl">Completados</div><div class="kv g" id="ld">0</div><div class="ks">módulos</div></div>
      <div class="kpi y"><div class="kl">Nivel actual</div><div class="kv y" id="l-nivel" style="font-size:11px">Básico</div><div class="ks">en progreso</div></div>
      <div class="kpi p"><div class="kl">Próximo</div><div class="kv p" id="ln" style="font-size:10px">—</div><div class="ks">módulo</div></div>
    </div>
    <div class="row" style="align-items:flex-start">
      <!-- Lista de módulos -->
      <div class="card" style="width:280px;min-width:240px">
        <div class="ch"><span class="ct">📚 Módulos</span><span class="ctag">9 lecciones</span></div>
        <div class="cb p0"><div id="mod-grid" style="display:flex;flex-direction:column"></div></div>
      </div>
      <!-- Contenido del módulo activo -->
      <div class="card" style="flex:1" id="mod-content-card">
        <div class="ch" id="mod-content-header">
          <span class="ct">👈 Seleccioná un módulo</span>
        </div>
        <div class="cb" id="mod-content-body" style="max-height:520px;overflow-y:auto">
          <div style="text-align:center;padding:40px 20px;color:var(--text3)">
            <div style="font-size:48px;margin-bottom:16px">📚</div>
            <div style="font-size:13px">Elegí un módulo de la izquierda para empezar a aprender</div>
          </div>
        </div>
        <div id="mod-content-footer" style="display:none;padding:12px 14px;border-top:1px solid var(--border);display:none">
          <button class="btn bp" id="mod-complete-btn" onclick="completeCurrentMod()" style="width:100%;padding:10px">✅ Marcar como completado</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="page" id="p-calendario">
    <div class="kpi-row k3" style="margin-bottom:12px">
      <div class="kpi b"><div class="kl">Hoy</div><div class="kv b" id="cal-today">—</div><div class="ks">eventos</div></div>
      <div class="kpi y"><div class="kl">Alto impacto</div><div class="kv y" id="cal-high">—</div><div class="ks">esta semana</div></div>
      <div class="kpi g"><div class="kl">Próximo</div><div class="kv g" id="cal-next" style="font-size:10px">—</div><div class="ks">evento clave</div></div>
    </div>
    <div class="row">
      <div class="card" style="flex:1">
        <div class="ch">
          <span class="ct">📅 Calendario Económico</span>
          <div style="display:flex;gap:6px;align-items:center">
            <select class="fi" id="cal-filter" style="padding:3px 8px;font-size:10px" onchange="renderCal()">
              <option value="all">Todos</option>
              <option value="high">⚠️ Alto impacto</option>
              <option value="us">🇺🇸 USA</option>
              <option value="ar">🇦🇷 Argentina</option>
              <option value="crypto">₿ Cripto</option>
            </select>
            <button class="btn bg2b" onclick="loadCalendar()" style="padding:4px 10px;font-size:10px">↻ Actualizar</button>
          </div>
        </div>
        <div class="cb p0">
          <div id="cal-body" style="overflow-y:auto;max-height:520px"></div>
        </div>
      </div>
      <div class="card" style="width:260px;min-width:220px">
        <div class="ch"><span class="ct">🎯 Eventos Clave</span></div>
        <div class="cb">
          <div id="cal-upcoming" style="display:flex;flex-direction:column;gap:8px"></div>
          <div style="margin-top:14px;padding-top:12px;border-top:1px solid var(--border)">
            <div style="font-size:9px;text-transform:uppercase;color:var(--text3);margin-bottom:8px">Fuente externa</div>
            <a href="https://es.investing.com/economic-calendar/" target="_blank" class="btn bg2b" style="display:block;text-align:center;font-size:10px;padding:8px">📅 Investing.com →</a>
            <a href="https://www.forexfactory.com/calendar" target="_blank" class="btn bg2b" style="display:block;text-align:center;font-size:10px;padding:8px;margin-top:6px">📅 Forex Factory →</a>
            <a href="https://www.bcra.gob.ar/PublicacionesEstadisticas/Calendario_fechas_de_publicacion.asp" target="_blank" class="btn bg2b" style="display:block;text-align:center;font-size:10px;padding:8px;margin-top:6px">🇦🇷 BCRA Argentina →</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="page" id="p-conversor">
    ...
    <div class="kpi-row k4" id="fx-kpis">
      <div class="kpi b"><div class="kl">USD Oficial</div><div class="kv b" id="fx-oficial">—</div><div class="ks">Banco Nación</div></div>
      <div class="kpi g"><div class="kl">USD Blue</div><div class="kv g" id="fx-blue">—</div><div class="ks">Mercado informal</div></div>
      <div class="kpi y"><div class="kl">USD MEP</div><div class="kv y" id="fx-mep">—</div><div class="ks">Bolsa (AL30)</div></div>
      <div class="kpi p"><div class="kl">USD CCL</div><div class="kv p" id="fx-ccl">—</div><div class="ks">Cable / GD30</div></div>
    </div>
    ...
    <div class="row">
      ...
      <div class="card col">
        <div class="ch">
          <span class="ct">💱 Calculadora de Conversión</span>
        ...
        <div class="cb">
          ...
          <div style="display:flex;gap:8px;margin-bottom:12px;align-items:flex-end">
            ...
            <button class="btn bg2b" style="padding:8px 12px;font-size:16px;margin-bottom:0" onclick="swapFX()" title="Invertir">⇄</button>
            <div class="fg" style="flex:1">
          ...
          <div style="background:var(--bg3);border:1px solid var(--border);border-radius:8px;padding:20px;text-align:center;margin-bottom:12px">
            <div style="font-size:11px;color:var(--text3);margin-bottom:6px" id="fx-formula">— → —</div>
            <div style="font-size:36px;font-weight:800;font-family:'Syne',sans-serif;color:var(--blue)" id="fx-result">—</div>
          ...
          <div style="margin-bottom:10px">
            ...
            <div style="display:flex;gap:6px;flex-wrap:wrap" id="fx-tipo-btns">
              <button class="btn bg2b fx-tipo on" data-tipo="blue" onclick="setTipo(this,'blue')" style="font-size:10px;padding:4px 10px">💵 Blue</button>
              <button class="btn bg2b fx-tipo" data-tipo="oficial" onclick="setTipo(this,'oficial')" style="font-size:10px;padding:4px 10px">🏦 Oficial</button>
              <button class="btn bg2b fx-tipo" data-tipo="mep" onclick="setTipo(this,'mep')" style="font-size:10px;padding:4px 10px">📈 MEP</button>
              <button class="btn bg2b fx-tipo" data-tipo="ccl" onclick="setTipo(this,'ccl')" style="font-size:10px;padding:4px 10px">🔗 CCL</button>
            </div>
          </div>

          <!-- Conversión rápida -->
          <div style="font-size:9px;text-transform:uppercase;letter-spacing:1px;color:var(--text3);margin-bottom:6px">Montos rápidos (USD)</div>
      ...
      <div class="card col">
        <div class="ch">
          <span class="ct">Tabla — 1 USD en todo</span>
          <button class="btn bg2b" style="font-size:9px;padding:3px 8px" onclick="fetchRates(true)">🔄 Actualizar</button>
        </div>
    ...
    <div class="card">
      ...
      <div class="cb p0" style="max-height:160px;overflow-y:auto" id="fx-history">
        <div style="padding:16px;text-align:center;color:var(--text3);font-size:11px">Las conversiones que hagás aparecen acá.</div>
      </div>
    </div>
  ...
  <div class="page" id="p-alertas">
    ...
    <div style="display:flex;align-items:center;gap:10px;margin-bottom:12px;padding:10px 14px;background:var(--bg2);border:1px solid var(--border);border-radius:7px">
      ...
      <span style="font-size:11px;color:var(--text2);flex:1" id="al-status-txt">Motor detenido — configurá tu API key y presioná Iniciar</span>
      <span style="font-size:10px;color:var(--text3)" id="al-next-scan">—</span>
      <button class="btn bp" id="al-start-btn" onclick="toggleScanner()">▶ Iniciar Scanner</button>
      <button class="btn bwa" onclick="shareAlertsWA()" style="font-size:10px;padding:5px 10px">📱 WA</button>
    </div>

    <div class="row">
      <!-- Config panel -->
      <div class="card" style="width:280px;flex-shrink:0">
        <div class="ch"><span class="ct">⚙️ Configuración</span></div>
        <div class="cb" style="overflow-y:auto;max-height:calc(100vh - 200px)">
          ...
          <div class="fg" style="margin-bottom:10px">
            <input class="fi" id="al-key" type="password" placeholder="sk-ant-…" style="font-size:10px">
          ...
          <div style="display:flex;gap:5px;margin-bottom:14px">
            <input class="fi" id="al-add-sym" placeholder="Ej: MELI, SOL…" style="font-size:10px;flex:1" onkeydown="if(event.key==='Enter')addToWatchlist()">
            <button class="btn bp" style="padding:5px 9px;font-size:11px" onclick="addToWatchlist()">＋</button>
          </div>
          ...
          <div style="font-size:11px;color:var(--text2);line-height:2.2">
            ...
            <label style="display:flex;align-items:center;gap:8px;cursor:pointer">
              <input type="checkbox" id="f-volume" checked style="accent-color:var(--blue)"> Volumen anómalo (2x+)
            </label>
            <label style="display:flex;align-items:center;gap:8px;cursor:pointer">
          ...
          <div style="margin-top:14px;padding-top:12px;border-top:1px solid var(--border)">
            <div style="font-size:9px;text-transform:uppercase;letter-spacing:1px;color:var(--text3);margin-bottom:6px">Mínimo R:R para alertar</div>
            <div style="display:flex;align-items:center;gap:8px">
              <input class="fi" id="al-min-rr" type="number" value="2" step="0.5" style="width:70px;font-size:11px">
              <span style="font-size:11px;color:var(--text2)">mínimo 1:X</span>
            </div>
          </div>
          ...
          <div style="margin-top:14px;padding:10px;background:var(--bg3);border-radius:6px;border:1px solid var(--border)">
            ...
            <input class="fi" id="al-webhook" placeholder="https://tu-n8n.railway.app/webhook/…" style="font-size:9px;margin-bottom:5px">
            <div style="font-size:9px;color:var(--text3)">Cuando configures N8N, pegá la URL acá y las alertas llegarán por WhatsApp automáticamente.</div>
          </div>
        </div>
      </div>
      ...
      <div style="flex:1;min-width:0;display:flex;flex-direction:column;gap:12px">
        ...
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:10px">
          <div class="kpi g"><div class="kl">Alertas Alcistas</div><div class="kv g" style="font-size:22px" id="al-bull-count">0</div><div class="ks">Señales de compra</div></div>
          <div class="kpi r"><div class="kl">Alertas Bajistas</div><div class="kv r" style="font-size:22px" id="al-bear-count">0</div><div class="ks">Señales de venta</div></div>
          <div class="kpi y"><div class="kl">Activos Escaneados</div><div class="kv y" style="font-size:22px" id="al-scanned">0</div><div class="ks">En esta sesión</div></div>
          <div class="kpi b"><div class="kl">Precisión Histórica</div><div class="kv b" style="font-size:22px" id="al-accuracy">—</div><div class="ks">Alertas confirmadas</div></div>
        </div>

        <!-- Feed de alertas -->
        <div class="card" style="flex:1">
          <div class="ch">
            <span class="ct">🔔 Feed de Alertas en Tiempo Real</span>
            <div style="display:flex;gap:6px;align-items:center">
              ...
              <button class="btn bg2b" style="font-size:9px;padding:3px 7px" onclick="clearAlerts()">🗑 Limpiar</button>
            </div>
          </div>
          <div style="overflow-y:auto;max-height:calc(100vh - 380px)" id="al-feed">
            <div style="padding:48px;text-align:center;color:var(--text3)">
              ...
              <div style="font-size:11px;line-height:1.7">Configurá tu watchlist, agregá la API key<br>y presioná <strong style="color:var(--blue)">▶ Iniciar Scanner</strong></div>
            </div>
          </div>
        </div>
      </div>
  ...
  <!-- ═══ RADAR DE NOTICIAS ═══ -->
  <div class="page" id="p-radar">

    <!-- Status bar -->
    <div style="display:flex;align-items:center;gap:10px;margin-bottom:12px;padding:10px 14px;background:var(--bg2);border:1px solid var(--border);border-radius:7px">
      <div style="width:8px;height:8px;border-radius:50%;background:var(--text3);flex-shrink:0" id="radar-dot"></div>
      <span style="font-size:11px;color:var(--text2);flex:1" id="radar-status">Listo para analizar el mundo</span>
      <span style="font-size:10px;color:var(--text3)" id="radar-time"></span>
      <button class="btn bp" onclick="runRadar()" id="radar-btn">🌍 Analizar ahora</button>
      <button class="btn bwa" onclick="shareRadarWA()" style="font-size:10px;padding:5px 10px">📱 WA</button>
    </div>

    <!-- KPIs -->
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:10px;margin-bottom:12px">
      <div class="kpi r"><div class="kl">Eventos de Riesgo</div><div class="kv r" style="font-size:22px" id="rd-risk">0</div><div class="ks">Geopolítica / macro</div></div>
      <div class="kpi g"><div class="kl">Oportunidades</div><div class="kv g" style="font-size:22px" id="rd-opp">0</div><div class="ks">Catalizadores positivos</div></div>
      <div class="kpi y"><div class="kl">Activos Alertados</div><div class="kv y" style="font-size:22px" id="rd-assets">0</div><div class="ks">Del watchlist</div></div>
      <div class="kpi b"><div class="kl">Última actualización</div><div class="kv b" style="font-size:13px;margin-top:4px" id="rd-updated">—</div><div class="ks">Auto cada 2 horas</div></div>
    </div>
    ...
    <div class="row" style="align-items:flex-start">
      ...
      <div style="flex:1;min-width:0;display:flex;flex-direction:column;gap:10px">
        <div class="card" style="flex:1">
          <div class="ch">
            <span class="ct">📰 Noticias con Impacto en Mercados</span>
            <div style="display:flex;gap:6px">
              <select class="fi" id="rd-filter" style="font-size:10px;padding:3px 8px;width:auto" onchange="filterRadar()">
                <option value="all">Todas</option>
                <option value="risk">Solo riesgos</option>
                <option value="opp">Solo oportunidades</option>
                <option value="crypto">Cripto</option>
                <option value="ar">Argentina</option>
                <option value="usa">Acciones USA</option>
              </select>
            </div>
          </div>
          <div id="rd-feed" style="overflow-y:auto;max-height:calc(100vh - 360px)">
            <div style="padding:48px;text-align:center;color:var(--text3)">
              <div style="font-size:36px;margin-bottom:12px">🌍</div>
              <div style="font-size:13px;font-weight:700;color:var(--text2);margin-bottom:6px">Radar de Noticias</div>
              <div style="font-size:11px;line-height:1.8">Analizá las noticias del mundo y su impacto<br>en tus activos del watchlist.<br><br>
              <strong style="color:var(--blue)">Requiere API Key de Anthropic</strong><br>
              <span style="font-size:10px;color:var(--text3)">Sin key funciona en modo demo</span></div>
              <button class="btn bp" style="margin-top:16px;padding:8px 20px" onclick="runRadar()">🌍 Analizar ahora</button>
            </div>
          </div>
        </div>
      </div>

      <!-- Panel derecho: activos watchlist + config -->
      <div style="width:260px;flex-shrink:0;display:flex;flex-direction:column;gap:10px">

        <!-- Activos afectados -->
        <div class="card">
          <div class="ch"><span class="ct">🎯 Activos a Monitorear</span></div>
          <div class="cb p0" style="max-height:220px;overflow-y:auto" id="rd-assets-list">
            <div style="padding:12px;font-size:10px;color:var(--text3)">Corré el análisis para ver qué activos del watchlist están afectados por las noticias de hoy.</div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="ch"><span class="ct">⚙️ Configuración</span></div>
          <div class="cb">
            <div style="font-size:9px;text-transform:uppercase;letter-spacing:1px;color:var(--text3);margin-bottom:6px">Foco de análisis</div>
            <div style="display:flex;flex-wrap:wrap;gap:5px;margin-bottom:12px">
              <label style="display:flex;align-items:center;gap:5px;font-size:10px;color:var(--text2);cursor:pointer"><input type="checkbox" id="rd-geo" checked style="accent-color:var(--red)"> Geopolítica</label>
              <label style="display:flex;align-items:center;gap:5px;font-size:10px;color:var(--text2);cursor:pointer"><input type="checkbox" id="rd-macro" checked style="accent-color:var(--blue)"> Macro / Fed</label>
              <label style="display:flex;align-items:center;gap:5px;font-size:10px;color:var(--text2);cursor:pointer"><input type="checkbox" id="rd-crypto" checked style="accent-color:var(--yellow)"> Cripto</label>
              <label style="display:flex;align-items:center;gap:5px;font-size:10px;color:var(--text2);cursor:pointer"><input type="checkbox" id="rd-ar" checked style="accent-color:var(--green)"> Argentina</label>
              <label style="display:flex;align-items:center;gap:5px;font-size:10px;color:var(--text2);cursor:pointer"><input type="checkbox" id="rd-tech" checked style="accent-color:var(--purple)"> Tech / IA</label>
              <label style="display:flex;align-items:center;gap=5px;font-size:10px;color:var(--text2);cursor:pointer"><input type="checkbox" id="rd-energy" checked style="accent-color:var(--orange)"> Energía / Petróleo</label>
            </div>
            <div style="font-size:9px;text-transform:uppercase;letter-spacing:1px;color:var(--text3);margin-bottom:6px">Auto-actualización</div>
            <div style="display:flex;gap:5px;flex-wrap:wrap">
              <button class="btn bg2b rd-auto on" data-h="2" onclick="setRadarAuto(this,2)" style="font-size:9px;padding:3px 7px">2h</button>
              <button class="btn bg2b rd-auto" data-h="4" onclick="setRadarAuto(this,4)" style="font-size:9px;padding:3px 7px">4h</button>
              <button class="btn bg2b rd-auto" data-h="0" onclick="setRadarAuto(this,0)" style="font-size:9px;padding:3px 7px">Manual</button>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="ch"><span class="ct">🌡️ Clima del Mercado</span></div>
          <div class="cb" style="text-align:center">
            <div id="rd-sentiment-emoji" style="font-size:40px;margin-bottom:6px">—</div>
            <div id="rd-sentiment-label" style="font-size:13px;font-weight:700;color:var(--text2);margin-bottom:4px">Sin datos</div>
            <div id="rd-sentiment-desc" style="font-size:10px;color:var(--text3);line-height:1.5">Corré el análisis para ver el clima actual del mercado global.</div>
          </div>
        </div>
